...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        bigquery_project_id=cfg.claw.bigquery.project_id,
        price_bigquery_dataset_id=cfg.claw.bigquery.dataset_id or "economics",
        price_bigquery_table_id=cfg.claw.bigquery.table_id or "german_shopping_receipts",
